...
go build -o ${out_dir}/server $HOME/Desktop/workspace/grpc-go/benchmark/server/main.go && go build -o ${out_dir}/client $HOME/Desktop/workspace/grpc-go/benchmark/client/main.go
if [ $? != 0 ]; then
  clean_and_die 1
fi
